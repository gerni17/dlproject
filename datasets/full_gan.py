...
# Data Module
class FullGanDataModule(pl.LightningDataModule):
    def __init__(self, source_dir, target_dir, transform, batch_size, split=True):
        super(FullGanDataModule, self).__init__()
