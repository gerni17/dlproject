...
python -m euler_run_gam --name gam_single_cycle --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 500 --gan_noise 0.7
