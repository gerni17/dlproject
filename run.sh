...
python -m scripts.train_gogoll --name gogol_50_r_1 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 50 --num_epochs_seg 55 --lr_ratio 1
python -m scripts.train_gogoll --name gogol_100_r_1 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 100 --num_epochs_seg 55 --lr_ratio 1
python -m scripts.train_gogoll --name gogol_150_r_1 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 150 --num_epochs_seg 55 --lr_ratio 1

python -m scripts.train_gogoll --name gogol_50_r_3 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 50 --num_epochs_seg 55
python -m scripts.train_gogoll --name gogol_100_r_3 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 100 --num_epochs_seg 55
python -m scripts.train_gogoll --name gogol_150_r_3 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 150 --num_epochs_seg 55

python -m scripts.train_gogoll --name gogol_50_r_9 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 50 --num_epochs_seg 55 --lr_ratio 9
python -m scripts.train_gogoll --name gogol_100_r_9 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 100 --num_epochs_seg 55 --lr_ratio 9
python -m scripts.train_gogoll --name gogol_150_r_9 --log_dir /cluster/scratch/$USER/logs --dataset_root /cluster/scratch/$USER/dl_data/data --use_wandb True --shared False --num_epochs_gogoll 150 --num_epochs_seg 55 --lr_ratio 9
