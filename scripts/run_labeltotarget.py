...
def main():
    ...
    trainer = Trainer(
        ...
        callbacks=[
            labeltotarget_checkpoint_callback,
    ...
    dm_generated = GeneratedLabelToTargetDataModule(
        generator, dm_source, batch_size=batch_size
    )
