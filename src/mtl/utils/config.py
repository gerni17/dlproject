...
def command_line_parser():
    ...
    parser.add_argument(
        '--gpu', type=bool, default=True, help='GPU usage')
    parser.add_argument(
    ...
    parser.add_argument(
        '--batch_size_validation', type=int, default=4, help='Number of samples in a batch for validation')
    ...
    parser.add_argument(
        '--dataset', type=str, default='segdata', choices=['segdata'], help='Dataset name')

    parser.add_argument(
        '--model_name', type=str, default='deeplabv3p', choices=['deeplabv3p','deeplabv3pp','deeplabv3psa'], help='CNN architecture')
    parser.add_argument(
    ...
    parser.add_argument(
        '--workers', type=int, default=10, help='Number of worker threads fetching training data')
    parser.add_argument(
