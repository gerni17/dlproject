...
class GogollExpertSystem(pl.LightningModule):
    def __init__(
        ...
        super(GogollExpertSystem, self).__init__()
        self.G_s2t = G_s2t
        self.G_t2s = G_t2s
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 0 or optimizer_idx == 1 or optimizer_idx == 4:
            ...
            loss_seg_a = self.semseg_loss(y_seg_s, segmentation_img.long())
            loss_seg_b = self.semseg_loss(y_seg_t, segmentation_img.long())
